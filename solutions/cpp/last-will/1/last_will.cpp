...
namespace estate_executor {
    ...
    int assemble_code() {
    auto red = garcia::red::code_fragment() + khan::red::code_fragment() + zhang::red::code_fragment();
    auto blue = garcia::blue::code_fragment() + khan::blue::code_fragment() + zhang::blue::code_fragment();
        return red * blue;
    }
}